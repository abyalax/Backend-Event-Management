...
export class Generated1777508652568 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "event_media" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "event_id" uuid NOT NULL, "media_id" uuid NOT NULL, "type" character varying NOT NULL DEFAULT 'banner', "order" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_4e5f0c8c1718c8c2026c15296af" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_2b7b8d6f6ebcd65da777932b84" ON "event_media" ("event_id", "type") WHERE type = 'banner'`);
